...
export default function AudioPlayer() {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-slate-900 px-6">
      ...
      <div className="w-full max-w-xl rounded-3xl bg-white/5 backdrop-blur-xl p-8 border border-white/10">
...
<div className="mb-8 text-center">
  ...
  <p className="text-slate-300 leading-8">
    ...
    suara yang setara Justin Bieber itu Mwheehehe
        ...
        <button
          onClick={toggleAudio}
          className="w-16 h-16 rounded-full bg-indigo-600 flex items-center justify-center hover:scale-110 transition"
        >
